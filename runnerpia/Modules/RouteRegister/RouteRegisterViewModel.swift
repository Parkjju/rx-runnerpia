...
class RouteRegisterViewModel: ViewModelType {
    ...
    func transform(input: Input) -> Output {
        ...
        return Output(secureTagCellItems: secureTagItems.asDriver(), recommendedTagCellItems: recommendedTagItems.asDriver(), attributedText: attributedText.asObservable(), textCount: textCountLabel.asObservable(), photoCellItems: photoItems.asDriver(), presentPickerView: presentPickerView.asDriver(onErrorJustReturn: ()), isEnabled: isEnabled.asDriver())
    }
}
